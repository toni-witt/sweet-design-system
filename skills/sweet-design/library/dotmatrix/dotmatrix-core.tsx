...
import "@/components/lab/dotmatrix/dotmatrix-loader.css";
import type { ReactNode } from "react";
import { useEffect, useMemo, useRef } from "react";
import { useDotMatrixPhases, usePrefersReducedMotion, useCyclePhase } from "@/components/lab/dotmatrix/dotmatrix-hooks";
  ...
  const dots = Array.from({ length: MATRIX_SIZE * MATRIX_SIZE }).map((_, index) => {
    ...
    if (isActive) {
      ...
      if (stylePatch != null && typeof rawOpacity === "number") {
        const remappedOpacity = styleOpacity(remapOpacityToTriplet(rawOpacity, ob, om, op));
